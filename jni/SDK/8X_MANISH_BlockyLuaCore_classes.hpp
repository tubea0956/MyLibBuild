...
public:
	...
	unsigned char                                      UnknownData38[0x76];                                      // 0x065A(0x0076) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGetLocaleString;                                        // 0x1370(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData15[0x4];                                       // 0x1370(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnCallCustomSelectObject;                                 // 0x1380(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData16[0x4];                                       // 0x1380(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnReceiveCustomSelectObject;                              // 0x1390(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData17[0x4];                                       // 0x1390(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnCheckShowCustomSelection;                               // 0x13A0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData18[0x4];                                       // 0x13A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnShowPresetPanelHandler;                                 // 0x13B0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData19[0x4];                                       // 0x13B0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnCheckShowPresetFilterBtn;                               // 0x13C0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData20[0x4];                                       // 0x13C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnModifyTip;                                              // 0x13D0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData21[0x4];                                       // 0x13D0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnAddBlockyLog;                                           // 0x13E0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData22[0x4];                                       // 0x13E0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnGetValidString;                                         // 0x13F0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData23[0x4];                                       // 0x13F0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnCheckStringValid;                                       // 0x1400(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData24[0x4];                                       // 0x1400(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMessageData;                                            // 0x1410(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData25[0x4];                                       // 0x1410(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnIsCurrentCultureLTR;                                    // 0x1420(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData26[0x4];                                       // 0x1420(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnGetTextLen;                                             // 0x1430(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData27[0x4];                                       // 0x1430(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnPlayPresetSound;                                        // 0x1440(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData28[0x4];                                       // 0x1440(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnOpenGuide;                                              // 0x1450(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData29[0x4];                                       // 0x1450(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnSetGraphSetting;                                        // 0x1460(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData30[0x4];                                       // 0x1460(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnGetBlockNewState;                                       // 0x1470(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData31[0x4];                                       // 0x1470(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnSetBlockNewState;                                       // 0x1480(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData32[0x4];                                       // 0x1480(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnGetSearchHistorys;                                      // 0x1490(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData33[0x4];                                       // 0x1490(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnSetSearchHistorys;                                      // 0x14A0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData34[0x4];                                       // 0x14A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnGetUrlIconAsset;                                        // 0x14B0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData35[0x4];                                       // 0x14B0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnCallUrlIconAssetToLoad;                                 // 0x14C0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData36[0x4];                                       // 0x14C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnCallPresetSelectedCode;                                 // 0x14D0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData37[0x4];                                       // 0x14D0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData38[0x70];                                      // 0x14E0(0x0070) MISSED OFFSET
	class UHotfixUtility*                              HotfixUtility;                                            // 0x1550(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData39[0x50];                                      // 0x1558(0x0050) MISSED OFFSET
