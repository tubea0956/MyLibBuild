...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0178(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0250(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0250(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData04[0x12];                                      // 0x0266(0x0012) MISSED OFFSET
