...
public:
	...
	unsigned char                                      UnknownData06[0x2];                                       // 0x008E(0x0002) MISSED OFFSET
	struct FScriptDelegate                             OnCoreCodeLoad;                                           // 0x0090(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData07[0x4];                                       // 0x008E(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
