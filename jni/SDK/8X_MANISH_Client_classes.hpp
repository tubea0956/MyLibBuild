...
public:
	...
	unsigned char                                      UnknownData09[0x70];                                      // 0x00E8(0x0070) MISSED OFFSET
	struct FScriptDelegate                             OpenMicFail;                                              // 0x0158(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData10[0x4];                                       // 0x00E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenMicSuccess;                                           // 0x0168(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0168(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseMicFail;                                             // 0x0178(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0178(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             BeforeOperation;                                          // 0x0188(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0188(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseMicSuccess;                                          // 0x0198(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData14[0x4];                                       // 0x0198(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenSpeakerFail;                                          // 0x01A8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData15[0x4];                                       // 0x01A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenSpeakerSuccess;                                       // 0x01B8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData16[0x4];                                       // 0x01B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseSpeakerFail;                                         // 0x01C8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData17[0x4];                                       // 0x01C8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseSpeakerSuccess;                                      // 0x01D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData18[0x4];                                       // 0x01D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinRoomFail;                                             // 0x01E8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData19[0x4];                                       // 0x01E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinRoomNotify;                                           // 0x01F8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData20[0x4];                                       // 0x01F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitRoomNotify;                                           // 0x0208(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData21[0x4];                                       // 0x0208(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinLbsRoomNotify;                                        // 0x0218(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData22[0x4];                                       // 0x0218(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitLbsRoomNotify;                                        // 0x0228(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData23[0x4];                                       // 0x0228(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RoomStatusUpdatedNotify;                                  // 0x0238(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData24[0x4];                                       // 0x0238(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SetAppInfoSuccess;                                        // 0x0248(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData25[0x4];                                       // 0x0248(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SetAppInfoFail;                                           // 0x0258(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData26[0x4];                                       // 0x0258(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             GetReconnectInfo;                                         // 0x0268(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData27[0x4];                                       // 0x0268(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ImSpeakingNotify;                                         // 0x0278(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData28[0x4];                                       // 0x0278(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             TestMicFail;                                              // 0x0288(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData29[0x4];                                       // 0x0288(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             TestMicSuccess;                                           // 0x0298(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData30[0x4];                                       // 0x0298(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitRoomFail;                                             // 0x02A8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData31[0x4];                                       // 0x02A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             DownLoadFileNotify;                                       // 0x02B8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData32[0x4];                                       // 0x02B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadFileNotify;                                         // 0x02C8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData33[0x4];                                       // 0x02C8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             KwsNotify;                                                // 0x02D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData34[0x4];                                       // 0x02D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ApplyMessageKeyNotify;                                    // 0x02E8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData35[0x4];                                       // 0x02E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             MemberIsSpeakingNotify;                                   // 0x02F8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData36[0x4];                                       // 0x02F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             LbsMemberIsSpeakingNotify;                                // 0x0308(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData37[0x4];                                       // 0x0308(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMuteSwitchResult;                                       // 0x0318(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData38[0x4];                                       // 0x0318(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ReportVoiceTimeToServer;                                  // 0x0328(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData39[0x4];                                       // 0x0328(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RecordSuccess;                                            // 0x0338(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData40[0x4];                                       // 0x0338(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RecordFail;                                               // 0x0348(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData41[0x4];                                       // 0x0348(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadSuccess;                                            // 0x0358(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData42[0x4];                                       // 0x0358(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadFail;                                               // 0x0368(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData43[0x4];                                       // 0x0368(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             EnableRoomMicrophone;                                     // 0x0378(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData44[0x4];                                       // 0x0378(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ExitInfectionGameMode;                                    // 0x0388(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData45[0x4];                                       // 0x0388(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinInfectionGameMode;                                    // 0x0398(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData46[0x4];                                       // 0x0398(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RequestPrivacyInSetting;                                  // 0x03A8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData47[0x4];                                       // 0x03A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnReportPlayerCallback;                                   // 0x03B8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData48[0x4];                                       // 0x03B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnVoiceSDKEvent;                                          // 0x03C8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData49[0x4];                                       // 0x03C8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             BeforeVoiceSDKInitDelegate;                               // 0x03D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData50[0x4];                                       // 0x03D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             AfterVoiceSDKInitDelegate;                                // 0x03E8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData51[0x4];                                       // 0x03E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             AudioRouteChangedAfterSpeakerDelegate;                    // 0x03F8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData52[0x4];                                       // 0x03F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             AudioSessionInterruptedDelegate;                          // 0x0408(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData53[0x4];                                       // 0x0408(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRoomMemeberInfoDelegate;                                // 0x0418(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData54[0x4];                                       // 0x0418(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData55[0x88];                                      // 0x0428(0x0088) MISSED OFFSET
	struct FScriptDelegate                             OnDeliverDataCallback;                                    // 0x04B0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData56[0x4];                                       // 0x0428(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
