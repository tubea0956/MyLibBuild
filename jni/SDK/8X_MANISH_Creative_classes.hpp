...
public:
	...
	struct FScriptDelegate                             MatLoadSuccessDelegate;                                   // 0x09D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x09A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
