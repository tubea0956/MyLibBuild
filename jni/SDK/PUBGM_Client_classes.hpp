...
public:
	...
	struct FScriptDelegate                             OnImagePickDetectEvent;                                   // 0x0AF0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnVideoPickEvent;                                         // 0x0B00(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x0B10(0x0010) (ZeroConstructor, InstancedReference)
